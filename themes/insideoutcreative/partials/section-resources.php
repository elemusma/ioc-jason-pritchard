...
echo '<div class="d-flex align-items-center justify-content-center position-relative z-3 h-100" style="">';
...
echo '<span class="text-white col-resources-title h3">' . esc_html( $link_title ) . '</span>';
echo '</div>';
echo '</a>';
