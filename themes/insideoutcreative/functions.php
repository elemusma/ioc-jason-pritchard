...
function jason_pritchard_stylesheets() {
...
if(is_front_page() || is_page_template('templates/resources.php') || is_page_template('templates/resources-individual.php') ){
...
add_action('wp_enqueue_scripts', 'jason_pritchard_stylesheets');
// for footer
function jason_pritchard_stylesheets_footer() {
...
add_action('get_footer', 'jason_pritchard_stylesheets_footer');
...
function jason_pritchard_menus() {
...
add_action('after_setup_theme', 'jason_pritchard_menus');
...
function btn_shortcode( $atts, $content = null ) {
    ...
    return '<a class="btn-accent-primary ' . esc_attr($a['class']) . '" href="' . esc_attr($a['href']) . '" target="' . esc_attr($a['target']) . '" style="' . esc_attr($a['style']) . '">' . $content . '</a>';
...
// add_shortcode( 'button_custom', 'button_custom_shortcode');

// function button_custom_shortcode( $text, $link, $target ){
// 	return '<a href="' . $link . '" target="' . $target . '" class="btn-accent-primary">' . $text . '</a>';
// 	// [button_custom text=""]
// }
...
function custom_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Videos', 'Video', 'text_domain' ),
