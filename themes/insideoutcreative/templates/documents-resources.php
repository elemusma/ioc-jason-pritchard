...
echo '<section class="position-relative" style="background:url(' . wp_get_attachment_image_url($bgImg['id'], 'full') . ');background-attachment:fixed;background-size:cover;padding:100px 0;">';
...
echo '<div class="position-relative h-100 d-flex align-items-center justify-content-center pl-3 pr-3 pt-2 pb-2" style="background:rgba(255,255,255,.5);border:1px solid #d4d2d0;">';
