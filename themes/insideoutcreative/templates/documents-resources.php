...
echo '<a href="' . esc_url( $link_url ) . '" target="' . esc_attr( $link_target ) . '" class="col-lg-3 col-md-6 col-documents-resources text-center mb-3 text-black" style="">';
echo '<div class="position-relative h-100 d-flex align-items-center justify-content-center pl-3 pr-3 pt-4 pb-2" style="background:rgba(255,255,255,.5);border:1px solid #d4d2d0;border-radius:15px;">';
echo '<div class="">';
echo '<span class="bold">' . esc_html( $link_title ) . '</span>';
